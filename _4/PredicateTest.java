 ...
 */
    ...
    void filterUsingPredicate() {
        // Use lambda expression and assign it to a variable
        Predicate<Person> ageMoreThan30 = (p -> p.getAge() > 30);


        Predicate<Person> ageLessThan20 = (p -> p.getAge() < 20);


        Predicate<Person> peopleOlderThan30AndYoungerThen20 = (p -> p.getAge() > 30 && p.getAge() < 20);
